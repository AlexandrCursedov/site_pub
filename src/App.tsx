        ...
        <div className="main">
            <header>
                <div className="nenu_and_logo2">
                    <div className='menu123123' onClick={open_modal}><img src="./assets/burger.png" /></div>
                    <div><img src="./assets/Group (1).png" /></div>

                </div>
                <div className="navss">
                    <img onClick={open_modal3} className='m_hide' src="./assets/call.png" alt="" />
                    <img onClick={open_modal2} className='m_hide' src="./assets/chat copy 2.png" alt="" />
            ...
            <div className="modal_menu">
                <div className='kjasdjsad'>
                    <div className="nenu_and_logo2">
                        <div className='menu123123' onClick={open_modal}><img src="./assets/burger copy.png" /></div>
                        <div><img src="./assets/Group (1).png" /></div>
                ...
                <div className="adaqjmsdfk">
                    <div className="contacts">
                        <div className="contacts_icons">
                            <img onClick={open_modal3} src="./assets/chat copy.png" />
                            <img onClick={open_modal2} src="./assets/chat.png" />
            ...
            <div className="modal_obrat_svaz">
                <div className='menu123123' onClick={open_modal2}><img src="./assets/burger copy.png" /></div>
            ...
            <div className="zakaz_zvon">
                <div className='menu123123' onClick={open_modal3}><img src="./assets/burger copy.png" /></div>
                <div className="asdjkasjdksajkd">
                    <div className="lkjwqirwerwer">
                        <img alt="" src="./assets/highlight.png" />
